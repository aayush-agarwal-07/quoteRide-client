...
export default function CommentSection({ postId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://quoterider-server.onrender.com/api/comment/create",
        {
          method: "POST",
          headers: {
  ...
  const handleLike = async (commentId) => {
    try {
      ...
      const res = await fetch(
        `https://quoterider-server.onrender.com/api/comment/likeComment/${commentId}`,
        {
          method: "PUT",
        }
      );
  ...
  const handleDelete = async (commentId) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://quoterider-server.onrender.com/api/comment/deleteComment/${commentId}`,
        {
          method: "DELETE",
        }
      );
