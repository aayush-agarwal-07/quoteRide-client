...
export default function DashComments() {
    ...
    const fetchComments = async () => {
      try {
        const res = await fetch(
          `https://quoterider-server.onrender.com/api/comment/getcomments`
        );
  ...
  const handleShowMore = async () => {
    ...
    try {
      const res = await fetch(
        `https://quoterider-server.onrender.com/api/comment/getcomments?startIndex=${startIndex}`
      );
      const data = await res.json();
      if (res.ok) {
  ...
  const handleDeleteComment = async () => {
    ...
    try {
      const res = await fetch(
        `https://quoterider-server.onrender.com/api/comment/deleteComment/${commentIdToDelete}`,
        {
          method: "DELETE",
        }
      );
