...
export default function DashUsers() {
    ...
    const fetchUsers = async () => {
      try {
        const res = await fetch(
          `https://quoterider-server.onrender.com/api/user/getusers`
        );
  ...
  const handleShowMore = async () => {
    ...
    try {
      const res = await fetch(
        `https://quoterider-server.onrender.com/api/user/getusers?startIndex=${startIndex}`
      );
      const data = await res.json();
      if (res.ok) {
  ...
  const handleDeleteUser = async () => {
    try {
      const res = await fetch(
        `https://quoterider-server.onrender.com/api/user/delete/${userIdToDelete}`,
        {
          method: "DELETE",
        }
      );
